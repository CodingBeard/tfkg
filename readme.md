...
| Functional | Fraudulent Job Specs | Binary Classification      | Input, Embedding, LSTM, Concatenate, Dense             | `./examples/jobs`            |
| Sequential | Random imbalanced    | Categorical Classification | Input, Dense                                           | `./examples/class_weights`   |
| Sequential | Sign Language Images | Categorical Classification | Input, Conv2D, MaxPooling2D, GlobalMaxPooling2D, Dense | `./examples/sign`            |
