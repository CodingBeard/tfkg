...
- Tensorflow 2.6 experimental support: `go get github.com/codingbeard/tfkg v0.2.6.14`
...
- All layers, initializers, constraints, and regularizers found on: https://keras.io/api/layers/
