...
- Tensorflow 2.6 experimental support: `go get github.com/codingbeard/tfkg v0.2.6.15`
...
- All layers (including experimental), initializers, constraints, and regularizers found on: https://www.tensorflow.org/api_docs/python/tf/keras/layers
